                  ...
                  <tbody className="divide-y divide-[#C5A059]/5">
                    {requests.slice(0, 5).map((request: any) => (
                      <tr key={request.id} className="hover:bg-[#C5A059]/5 transition-colors">
                        ...
                        <td className="px-6 py-4 text-[#1C1917]/40">
                    ...
                    {requests.length === 0 && (
                      <tr>
                        <td colSpan={4} className="px-6 py-8 text-center text-[#1C1917]/40">
                    ...
                    {products.map((product) => (
                      <tr key={product.id} className="hover:bg-[#C5A059]/5 transition-colors">
                        <td className="px-6 py-4 flex items-center gap-3">
                          <div className="w-8 h-8 rounded bg-[#FFFFFF] border border-[#C5A059]/10 overflow-hidden">
                            <img
                        ...
                        <td className="px-6 py-4">
                          <span
                            className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${product.availability ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}
                          >
...
function NewProductForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const parsedPrice =
        form.price.trim() === "" ? undefined : Number(form.price.replace(",", "."));
  ...
  const inputClass =
    "w-full bg-[#FFFFFF] border border-[#C5A059]/20 rounded px-4 py-3 text-sm outline-none focus:border-[#C5A059] transition-colors";
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="bg-[#C5A059] text-[#14110D] shadow-[0_10px_30px_-10px_rgba(197,160,89,0.7)] px-6 py-3 rounded text-[10px] font-bold uppercase tracking-widest hover:bg-[#D4B473] transition-all disabled:opacity-50"
        >
